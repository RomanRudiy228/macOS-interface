  ...
  return (
    ...
    >
      <div className="flex h-full w-full min-h-full flex-col overflow-hidden rounded-xl">
        <div
          className={`flex shrink-0 cursor-grab active:cursor-grabbing items-center gap-3 border-slate-200 bg-slate-50 px-3 py-2 select-none transition-[border-radius,border-color] duration-200 ${isCollapsed ? "rounded-xl" : "rounded-t-xl border-b"}`}
        ...
        >
          ...
          <span className="flex-1 text-center text-[13px] font-medium text-slate-800 select-none">
            {title}
          </span>
