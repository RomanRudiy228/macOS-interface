  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-12 overflow-y-auto p-4">
      <section className="flex flex-col gap-3 mx-auto w-full max-w-md">
        <div
          className="h-72 w-full overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-700"
          style={{
        ...
        <div className="grid grid-cols-4 gap-3">
          {wallpapers.map((wallpaper) => (
            <button
              ...
              className="flex w-full flex-col items-center gap-1 rounded-lg p-0 transition-colors hover:bg-slate-100 dark:hover:bg-slate-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 dark:focus-visible:ring-slate-500"
            >
              <div
                className="w-full aspect-square overflow-hidden rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-100 dark:bg-slate-700"
                style={{
